...
namespace MissionPlanner.Controls
{
    public class HUD: Control
    {
        ...
        private Color _skyColor1 = Color.FromArgb(1, 99, 205);
        private Color _skyColor2 = Color.FromArgb(1, 99, 205);
        private Color _groundColor1 = Color.FromArgb(13, 69, 93);
        private Color _groundColor2 = Color.FromArgb(13, 69, 93);
        float _SSA = 0;
        ...
        public Color hudcolor
        {
            ...
            {
                _hudcolor = value;
                this._whitePen = new Pen(value, 1);
            }
        }
        ...
        {
            if (DesignMode || !base.IsHandleCreated || !started)
                return;
