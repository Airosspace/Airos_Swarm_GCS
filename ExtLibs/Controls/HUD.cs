...
namespace MissionPlanner.Controls
{
    public class graphicsObject : HUD
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Size = new System.Drawing.Size(478, 382);
            this.VSync = false;
        ...
        private void graphicsObject_Load(object sender, EventArgs e)
        {
    ...
    public class HUD : GLControl
    {
        ...
        private Color _skyColor1 = Color.FromArgb(22, 143, 250);
        private Color _skyColor2 = Color.FromArgb(22, 143, 250);
        private Color _groundColor1 = Color.FromArgb(212, 146, 54);
        private Color _groundColor2 = Color.FromArgb(212, 146, 54);
        ...
        internal void doPaint()
        {
            ...
            try
            {
                ...
                if (displayrollpitch)
                {
                            ...
                            if (a % 10 == 0)
                            {
                                ...
                                else
                                {
                                    graphicsObject.DrawLine(this._whitePen, this.Width / 2 - lengthlong - halfwidth,
                                        pitchoffset + a * every5deg, this.Width / 2 + lengthlong - 80 - halfwidth,
                                        pitchoffset + a * every5deg);

                                    drawstring(a.ToString(), font, fontsize - 3, _whiteBrush,
                                    this.Width - lengthlong - 190 - halfwidth - (int)(fontoffset * 1.7),
                                    pitchoffset + a * every5deg - 8 - fontoffset);

                                    graphicsObject.DrawLine(this._whitePen, this.Width / 2 - lengthlong + 80 - halfwidth,
                                        pitchoffset + a * every5deg, this.Width / 2 + lengthlong - halfwidth,
                                        pitchoffset + a * every5deg);
                                }
                            }
                    ...
                    int[] array = new int[] { 3, -45, 3, -20, 3, 0, 3, 20, 3, 45, 3 };
                    int[] array2 = new int[] { -60, -30, -10, 10, 30, 60 };
                    for (int i = 0; i < array.Length; i++)
                    {
                        if (array[i] != 3)
                        {
                            graphicsObject.ResetTransform();
                            graphicsObject.TranslateTransform(this.Width / 2, this.Height / 2);
                            graphicsObject.RotateTransform(array[i]- _roll);
                            drawstring(String.Format("{0,2}", Math.Abs(array[i])), font, fontsize - 3, _whiteBrush, 0 - 6 - fontoffset, -lengthlong * 8 - extra);
                            graphicsObject.DrawLine(this._blackPen, 0, -lengthlong * 3 - extra, 0, -lengthlong * 3 - extra - lengthlong);
                        }
                        else
                        {
                            foreach (int a in array2)
                            {
                                ...
                                graphicsObject.DrawLine(this._blackPen, 0, -lengthlong * 3 - extra, 0, -lengthlong * 3 - extra - lengthlong * 3);
                            }
                        } 
                    }
                    ...
                    //  graphicsObject.DrawEllipse(_redPen, centercircle); ._blackPen
                    using (Pen redtemp =
                        new Pen(Color.FromArgb(200, this._blackPen.Color.R, this._blackPen.Color.G, this._blackPen.Color.B),
                            4.0f))
                    {
                        // left
                        ...
                        // center point
                        graphicsObject.DrawLine(redtemp, 0 - 1, 0, centercircle.Right / 5, 0 + halfheight / 8);

                        graphicsObject.DrawLine(redtemp, centercircle.Right / 5, 0 + halfheight / 8, centercircle.Right - halfwidth / 3, 0);

                        graphicsObject.DrawLine(redtemp, centercircle.Right - halfwidth / 3, 0, centercircle.Right * 0.65, 0);

                        graphicsObject.DrawLine(redtemp, 0 + 1, 0, centercircle.Left /5 , 0 + halfheight / 8);

                        graphicsObject.DrawLine(redtemp, centercircle.Left / 5, 0 + halfheight / 8, centercircle.Left + halfwidth / 3, 0);

                        graphicsObject.DrawLine(redtemp, centercircle.Left + halfwidth / 3, 0, centercircle.Left * 0.65, 0);
                    }
                }
                ...
                if (displayheading)
                {
                    ...
                    // center
                    //   graphicsObject.DrawLine(_redPen, headbg.Width / 2, headbg.Bottom, headbg.Width / 2, headbg.Top);
                    ...
                    RectangleF rect = new RectangleF(headbg.Width / 2 - (fontsize * 2.4f) / 6, 0, (fontsize * 2.4f)/2,
                        headbg.Height);
                ...
                if (displayspeed)
                {
                    ...
                    arrow[2] = new Point(scrollbg.Width - 0, 0);
                    ...
                    drawstring((speed).ToString("0") + speedunit, font, 12, (SolidBrush) Brushes.AliceBlue, 5, -11);
                    ...
                    drawstring(_datetime.ToString("SPEED"), font, fontsize, _whiteBrush,
                        scrollbg.Left, scrollbg.Top - fontsize - 2 + 70);
                    drawstring(_datetime.ToString("ALT"), font, fontsize, _whiteBrush, 
                        scrollbg.Left + 450, scrollbg.Top - fontsize - 2 + 75);
                }
                ...
                if (displayalt)
                {
                    ...
                    for (long a = start; a <= (_alt + viewrange / 2); a += 1)
                    {
                        ...
                        if (a % 5 == 0)
                        {
                            ...
                            drawstring(String.Format("{0,5}", a), font, fontsize - 3, _whiteBrush,
